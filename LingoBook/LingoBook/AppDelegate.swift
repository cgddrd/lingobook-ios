...
//        let modelURL = NSBundle.mainBundle().URLForResource("LingoBook", withExtension: "momd")!
...
//        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("LingoBook.sqlite")
...
//    }()
//    
//    // 'lazy' defers execution of this function UNTIL IT IS ACTUALLY NEEDED!
